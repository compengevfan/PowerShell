...
try { WriteHost "Loading DVS Uplink data"; $dvsuplinks = Import-Csv D:\Cloud\Dropbox\Scripts\From_Al\vCenter-Migration\jxfq-vc001.fanatics.corp-DVS-Uplinks.csv -ErrorAction Stop }
