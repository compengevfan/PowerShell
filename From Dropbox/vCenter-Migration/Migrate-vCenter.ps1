[cmdletbinding()]
Param (
    [Parameter(ParameterSetName="server")][Parameter(ParameterSetName="cluster")]$SourcevCenter = "jxfq-vc001.fanatics.corp",
    [Parameter(ParameterSetName="server")][Parameter(ParameterSetName="cluster")]$DestvCenter = "jaxf-vc101.fanatics.corp",
