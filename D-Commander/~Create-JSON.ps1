...
while ($true)
{
    ...
    if ($TargetCluster -eq $null) { DoLogging -ScriptStarted $ScriptStarted -ScriptName $ScriptName -LogType Warn -LogString "Cluster named '$TargetClusterStr' does not exist. Please try again..." }
    else { break }
}
