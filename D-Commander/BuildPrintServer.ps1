...
if ($VMFile -eq "" -or $VMFile -eq $null) { cls; Write-Host "Please select a JSON file..."; $VMFile = Get-DfFileName -Filter "json" }
...
Invoke-DfLogging -ScriptStarted $ScriptStarted -ScriptName $ScriptName -LogType Succ -LogString "Your print server has been successfully configured!!!"
